...
export const PROSE = {
  ...
  h2: "mt-6 mb-2.5 border-l-2 border-signal pl-2.5 font-body text-[13px] font-bold uppercase tracking-eyebrow text-signal",
  /** Sub-heading inside a section. */
  h3: "mt-4 mb-1.5 font-body text-[11px] font-bold uppercase tracking-eyebrow text-readout-dim",
  ...
  th: "border-b border-edge px-2 py-1 text-left text-[10px] font-bold uppercase tracking-label text-readout-muted",
  td: "border-b border-hairline px-2 py-1.5 align-top text-readout",
  /** Muted note under a heading — source, scope, caveat. */
  note: "font-body text-[11px] font-bold uppercase tracking-label text-readout-muted",
} as const;
  ...
  return (
    <section>
      <div className="mt-6 mb-2.5 flex flex-wrap items-baseline justify-between gap-x-3 gap-y-1 border-l-2 border-signal pl-2.5">
        <h2 className="font-body text-[13px] font-bold uppercase tracking-eyebrow text-signal">
          {title}
        </h2>
