          ...
          {anchors.map((character, index) => {
            ...
            return (
              <div
                ...
                className="relative flex h-24 flex-col items-center justify-end overflow-hidden border-2 border-amber-300/70 bg-zinc-900/70"
              >
                {art ? (
                ...
                <span className="absolute left-1 top-1 z-10 border border-amber-300/70 bg-black/70 px-1 py-0.5 font-body text-[9px] uppercase tracking-widest text-amber-200">
                  {lockedNote}
                </span>
