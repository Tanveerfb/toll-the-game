export const mechanicGlossary = {
  ...
  raises: "Raises the stat (under 50%)",
  "greatly raises": "Raises the stat by 50-79%",
  "massively raises": "Raises the stat by 80%+",
  "permanently raises": "Raises the stat (under 50%) for the rest of battle",
  "permanently greatly raises": "Raises the stat by 50-79% for the rest of battle",
  "permanently massively raises": "Raises the stat by 80%+ for the rest of battle",
  "permanently lowers": "Reduces the target's stat (under 50%) for the rest of battle",
  "permanently greatly lowers": "Reduces the target's stat by 50-79% for the rest of battle",
  "permanently massively lowers": "Reduces the target's stat by 80%+ for the rest of battle",
} as const;
